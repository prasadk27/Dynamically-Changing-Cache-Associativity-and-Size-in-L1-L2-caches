//
// Host-system structures reflecting Alpha file headers for the loader.
//
// Jeff Brown
// $Id: loader-alphafilehdr.h,v 1.1.2.2.2.1 2008/04/30 22:17:51 jbrown Exp $
//

#ifndef LOADER_ALPHAFILEHDR_H
#define LOADER_ALPHAFILEHDR_H

#define Alpha_ALPHAMAGIC        0603
#define Alpha_ALPHAUMAGIC       0617    /* U-code object file */


struct alpha_aouthdr {
    short alpha_magic;
    short alpha_vstamp;
    short alpha_bldrev;
    short alpha_padcell;
    ...
    i64 alpha_bsize;
    i64 alpha_entry;
    i64 alpha_text_start;
    i64 alpha_data_start;
    i64 alpha_bss_start;
    i32 alpha_gprmask;
    i32 alpha_fprmask;
    i64 alpha_gp_value;
...
struct alpha_filehdr {
    unsigned short alpha_f_magic;
    unsigned short alpha_f_nscns;
    i32 alpha_f_timdat;
    i64 alpha_f_symptr;
    i32 alpha_f_nsyms;
    unsigned short alpha_f_opthdr;
    unsigned short alpha_f_flags;
};

struct alpha_execinfo {
    struct alpha_filehdr fh;
    struct alpha_aouthdr ah;
};
...
#endif // LOADER_ALPHAFILEHDR_H




#ifdef OLD_UNUSED_STUFF_NOT_DEFINED
 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /home/jbrown/cvsroot/merge_smtsim/src/Attic/loader-alphafilehdr.h,v 1.1.2.2.2.1 2008/04/30 22:17:51 jbrown Exp $ */
#ifndef _FILEHDR_H
#define _FILEHDR_H
...
typedef struct alphaaouthdr {
        short   magic;          /* see above                            */
        short   vstamp;         /* version stamp                        */
        short   bldrev;
        short   padcell;
        i64     tsize;          /* text size in bytes, padded to DW bdry*/
        i64     dsize;          /* initialized data "  "                */
        i64     bsize;          /* uninitialized data "   "             */
        i64     entry;  /* entry pt.                            */
        i64     text_start;     /* base of text used for this file      */
        i64     data_start;     /* base of data used for this file      */
        i64     bss_start;      /* base of bss used for this file       */
        int     gprmask;        /* general purpose register mask        */
        int     fprmask;        /* floating point register mask         */
        i64     gp_value;       /* the gp value used for this object    */
} alphaAOUTHDR;
...
struct alphafilehdr {
        ...
        i64             f_symptr;       /* file pointer to symbolic header */
...
typedef struct alpha_execinfo {
        struct alphafilehdr fh;
        alphaAOUTHDR ah;
} alpha_execinfo;
...
#endif  // OLD_UNUSED_STUFF_NOT_DEFINED
