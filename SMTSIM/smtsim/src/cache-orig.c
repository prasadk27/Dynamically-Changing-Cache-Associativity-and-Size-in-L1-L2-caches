                   ...
                   activelist *meminst, i64 ready_time)
{
...

    {
        ...
        //sim_assert(meminst->active_dmiss);
        //ctx->pending_dcache_misses--; // This decrements only for the drequestor
        //meminst->active_dmiss = 0;  // FIXME: deal with merged requests
