...
bbtracker_params_t BBTrackerParams;
...
void init_bb_tracker (const char* fname, long m_interval_size)
{
  int i;
...
void print_list (bb_node_ptr head, vector<int> * array) 
{
  do {
